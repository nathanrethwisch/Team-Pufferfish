...
One point of note is looking into how the length of the day affects car crashes. **INSERT FIGURE** shows the number of crashes based on the length of the day. A line of best fit was added to the graph using LOESS smoothing.
