...
library(rvest)
library(dplyr)
page <- read_html("https://www.timeanddate.com/sun/@4846834?month=11&year=2021")
...
final_weather <- final_weather[-8,]
final_weather$Month <- "November"
final_weather[1,]<- final_weather[33,]
final_weather <- final_weather[-2,]
final_weather <- final_weather[-31:-32,]
```

```{r}
final_weather$Sunrise <- final_weather$Sunrise
