...
In addition to this, I will be exploring the relationship between amount of property damage and injury severity
...
View(crashes)
crashes%>%
  filter(`Crash Severity` == 'Fatal', !is.na(`Travel Direction`))%>%
